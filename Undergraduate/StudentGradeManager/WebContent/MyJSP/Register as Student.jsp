	...
	<div
		...
		<div class="uk-section uk-padding-remove-vertical">
			<div
				...
				uk-img>
				<div>
					<form action="/StudentGradeManager/AddStudentServlet" method="post">
						<h3>Student Register</h3>
						<hr class="uk-divider-icon">
						<div class="uk-margin">
							<label class="uk-form-label" for="form-stacked-text">学生姓名</label>
							<div class="uk-form-controls">
								<div class="uk-margin">
									<div class="uk-inline">
										<span class="uk-form-icon" uk-icon="icon: user"></span> <input
											class="uk-input" type="text" name="stu_name"
											placeholder="Student_Name" required="required">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="uk-margin">
							<label class="uk-form-label" for="form-stacked-text">学生密码</label>
							<div class="uk-form-controls">
								<div class="uk-margin">
									<div class="uk-inline">
										<span class="uk-form-icon uk-form-icon-flip"
											uk-icon="icon: lock"></span> <input class="uk-input"
											type="password" name="stu_pwd" placeholder="Student_Password"
											required="required">
									</div>
								</div>
							</div>
						...
						<div class="uk-margin">
							<label class="uk-form-label" for="form-horizontal-select">学生所在院系</label>
							<div class="uk-form-controls">
								<select class="uk-select" id="form-horizontal-select"
									name="stu_department" required="required">
									<option value="" selected="selected">Student_Department</option>
						...
						<div class="uk-margin">
							<label class="uk-form-label" for="form-horizontal-text">学生电话</label>
							<div class="uk-form-controls">
								<input class="uk-input" id="form-horizontal-text" type="tel"
									name="stu_phone" placeholder="Student_Phone"
									required="required">
							</div>
						</div>

						<div class="uk-margin">
							<label class="uk-form-label" for="form-horizontal-text">学生出生日</label>
							<div class="uk-form-controls">
								<input class="uk-input" id="form-horizontal-text" type="date"
									name="stu_birth" placeholder="Student_Birth"
									required="required">
							</div>
						</div>
