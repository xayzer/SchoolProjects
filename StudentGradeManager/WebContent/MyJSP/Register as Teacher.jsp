	...
	<div
		...
		<div class="uk-section uk-padding-remove-vertical">
			<div
				...
				uk-img>
				<div>
					<form action="/StudentGradeManager/AddTeacherServlet" method="post">
			<h3>Teacher Register</h3>
			<hr class="uk-divider-icon">
			<div class="uk-margin">
				<label class="uk-form-label" for="form-stacked-text">教师姓名</label>
				<div class="uk-form-controls">
					<div class="uk-margin">
						<div class="uk-inline">
							<span class="uk-form-icon" uk-icon="icon: user"></span> <input
								class="uk-input" type="text" name="tea_name" placeholder="Teacher_Name" required="required">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="uk-margin">
				<label class="uk-form-label" for="form-stacked-text">教师密码</label>
				<div class="uk-form-controls">
					<div class="uk-margin">
						<div class="uk-inline">
							<span class="uk-form-icon uk-form-icon-flip" uk-icon="icon: lock"></span>
							<input class="uk-input" type="password" name="tea_pwd" placeholder="Teacher_Password" required="required">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="uk-margin">
				<label class="uk-form-label" for="form-horizontal-select">教师所在院系</label>
				<div class="uk-form-controls">
					<select class="uk-select" id="form-horizontal-select"
						name="tea_department" required="required">
						<option value="" selected="selected">Teacher_Department</option>
			...
			<div class="uk-margin">
				<label class="uk-form-label" for="form-horizontal-text">教师电话</label>
				<div class="uk-form-controls">
					<input class="uk-input" id="form-horizontal-text" type="tel"
						name="tea_phone" placeholder="Teacher_Phone" required="required">
				</div>
			</div>
